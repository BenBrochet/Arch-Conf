...
source "$HOME/projects/automation/gojo/GOjo.zsh"
# User configuration
...
alias hx="helix"
alias vpnstart='sudo wg-quick up protonvpn'
alias vpncheck='sudo wg show'
alias vpnkill='sudo wg-quick down protonvpn'
alias kitty='hx ~/.config/kitty/kitty.conf'
...
deepseek() {
  ...
  ollama run deepseek-coder-v2:16b-lite-instruct-fp16
}

# eDP-1 = laptop internal display
